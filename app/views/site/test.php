<nav class="navbar navbar-default navbar-fixed-top" style="background-color: transparent; border: 0;">
    <div class="container" style="background-color: white;">
        <h1 class="navbar-brand">Ribbit</h1>

    </div>
    <div class="container" style="margin: auto; width: 500px; background-color: #23c6c8;">
...
<?= \yii\bootstrap\Carousel::widget([
    'options' => ['class' => 'slide', 'id' => 'test-carousel'],
        ...
        '<div class="col-item">
                                ...
                                <div class="info">
                                    ...
                                    <div class="separator clear-left">
                                     ...
                                     <div class="controls">
                                        <a class="left fa fa-chevron-left btn btn-success" href="#test-carousel"
                                           data-slide="prev"></a>
